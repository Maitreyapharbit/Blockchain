...
Write-Host "Including Recall Management and Anti-Counterfeiting Features" -ForegroundColor Magenta
Write-Host ""
...
Start-Process -FilePath "npx" -ArgumentList "hardhat", "node" -WindowStyle Hidden -RedirectStandardOutput "..\logs\hardhat-node.log" -RedirectStandardError "..\logs\hardhat-error.log"
...
Start-Process -FilePath "node" -ArgumentList "simple-server.js" -WindowStyle Hidden -RedirectStandardOutput "..\logs\backend.log" -RedirectStandardError "..\logs\backend-error.log"
...
Start-Process -FilePath "npm" -ArgumentList "start" -WindowStyle Hidden -RedirectStandardOutput "..\logs\frontend.log" -RedirectStandardError "..\logs\frontend-error.log"
Start-Sleep -Seconds 5
...
Write-Host ""
Write-Host "Anti-Counterfeiting Features:" -ForegroundColor Magenta
